...
public class PPS_Director {
    ...
    public PPS_Director(int id, Persona persona, Pelicula_Serie pelicula_serie, String tipo) {
        this.id = id;
    ...
    public String toString() {
        return "PPS_Director{" + "id=" + id + ", persona=" + persona + ", pelicula_serie=" + pelicula_serie + ", tipo=" + tipo + '}';
    }
}
